...
install:
	...
	install -m 755 bin/git-sre "$(PREFIX)/bin/"
	install -m 755 bin/git-squash "$(PREFIX)/bin/"
	install -m 755 bin/git-dcommit "$(PREFIX)/bin/"
	install -m 755 bin/sshwait "$(PREFIX)/bin/"
