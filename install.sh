...
install -m 755 ./git-ourstheir "${PREFIX}/bin/"
install -m 755 ./git-sync-upstream "${PREFIX}/bin/"
...
install -m 755 ./git-finder-exec "${PREFIX}/bin/"
install -m 755 ./git-checkout-default "${PREFIX}/bin/"
install -m 755 ./git-author "${PREFIX}/bin/"
install -m 755 ./git-ls-files-dates "${PREFIX}/bin/"
install -m 755 ./emacs-diff "${PREFIX}/bin/"
install -m 755 ./osid "${PREFIX}/bin/"
install -m 755 ./git-is-clean "${PREFIX}/bin/"
install -m 755 ./.bash-stdops.inc.sh "${PREFIX}/bin/"
install -m 755 ./git-check-gpg "${PREFIX}/bin/"
install -m 755 ./is-battery-discharging "${PREFIX}/bin/"
